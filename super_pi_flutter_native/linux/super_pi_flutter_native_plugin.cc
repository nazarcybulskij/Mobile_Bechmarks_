...
class SuperPiFlutterNativePlugin : public flutter::Plugin {
 public:
  static void RegisterWithRegistrar(flutter::PluginRegistrarGlfw *registrar);

  SuperPiFlutterNativePlugin();

  virtual ~SuperPiFlutterNativePlugin();
...
// static
void SuperPiFlutterNativePlugin::RegisterWithRegistrar(
    flutter::PluginRegistrarGlfw *registrar) {
  auto channel =
      std::make_unique<flutter::MethodChannel<flutter::EncodableValue>>(
          registrar->messenger(), "super_pi_flutter_native",
          &flutter::StandardMethodCodec::GetInstance());
  auto plugin = std::make_unique<SuperPiFlutterNativePlugin>();
...
SuperPiFlutterNativePlugin::SuperPiFlutterNativePlugin() {}

SuperPiFlutterNativePlugin::~SuperPiFlutterNativePlugin() {}

void SuperPiFlutterNativePlugin::HandleMethodCall(
    const flutter::MethodCall<flutter::EncodableValue> &method_call,
    std::unique_ptr<flutter::MethodResult<flutter::EncodableValue>> result) {
...
void SuperPiFlutterNativePluginRegisterWithRegistrar(
  ...
  SuperPiFlutterNativePlugin::RegisterWithRegistrar(insert_result.first->second.get());
}
